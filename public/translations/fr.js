...
const fr = {
  ...
  'sidebar.moreTags': "plus d'étiquettes",
  'sidebar.moreCategories': 'plus de catégories',
  'sidebar.showLess': 'Voir moins',
  'media.videoResources': 'Ressources vidéo',
  'media.mute': 'Muet',
  'media.unmute': 'Activer le son',
  'media.openOnYouTube': 'Voir sur YouTube',
  'media.viewOnInstagram': 'Voir sur Instagram',
  ...
  'home.throughMyLens': 'De mon point de vue',
  'home.whatYouFindHere': 'Ce que vous trouverez ici',
  'home.lifeBeyondCode': 'La vie au-delà du code',
  'home.lifeBeyondCodeDesc': 'Un journal numérique pour des découvertes non techniques, des leçons de vie et des observations importantes au-delà du travail.',
  'home.realExperiences': 'Expériences réelles',
  'home.realExperiencesDesc': 'Des informations accessibles à vous et à mon futur moi – des rappels de ce qui compte vraiment dans la vie.',
  'home.multilingualStories': 'Publications multilingues',
  'home.multilingualStoriesDesc': 'Contenu créé en 9 langues, reliant diverses perspectives du monde entier.',
  'home.discoveries': 'Observations',
  'home.languages': 'Langues',
  'home.insights': 'Perspectives',
  'home.readyToExplore': 'Prêt à explorer?',
  'home.discoverInsights': 'Expériences de vie réelles au-delà du bruit technique.',
  'home.startReading': 'Commençons',
  'home.featuredStories': 'Publications en vedette',
  'home.featuredStoriesDesc': 'Leçons de vie, observations et expériences au-delà du bruit technique',
  'home.featured': 'En vedette',
  'home.viewAllStories': 'Collection de toutes les publications',
  ...
  'post.lastUpdatedTip1': 'Cet article a été mis à jour pour la dernière fois le',
  'post.lastUpdatedTip2': ' et certaines informations peuvent ne plus être applicables en raison du temps écoulé.',
  'post.legacy': 'Obsolète',
  'post.legacyWarning': 'CONTENU OBSOLÈTE',
  'post.legacyTip1': 'Cet article a été mis à jour pour la dernière fois le',
  'post.legacyTip2': '. Les informations sont obsolètes et conservées uniquement à titre de référence historique.',
  ...
  'remark.open': 'Ouvrir',
  'remark.exploreFurther': 'Explorer davantage',
  'more': 'Plus',
...
**Les chroniques du hibou nocturne** : La musique est mon compagnon constant pendant ces heures tardives de la nuit quand le monde se calme. Je ne suis pas lié à des artistes spécifiques ; ce qui me captive, ce sont les paroles significatives qui résonnent avec les expériences de vie. La nuit fait ressortir ma pensée la plus créative - il y a quelque chose de magique dans le silence qui permet aux idées de couler librement. J'ai été une créature de la nuit depuis l'enfance, me précipitant souvent aux examens après avoir étudié jusqu'à l'aube.

**Les plaisirs simples de la vie** : Je suis un passionné de Ludo et un amateur de nourriture dévoué avec une faiblesse sérieuse pour l'authentique biryani d'Hyderabad - une histoire d'amour qui a commencé à Delhi grâce aux chaînes de restaurants populaires comme Biryani Blues et Bikkgane Biryani. Je me suis lancé dans une quête du biryani, goûtant tout, du style afghan de Behrouz aux variétés régionales comme Ambur, Thalappakatti et Muradabadi. Mes aventures culinaires s'étendent aux délices de rue comme les momos, les chaussons aux œufs, le kachodi, le chaap, le vada pav et le pav bhaji, bien que j'admette que la nourriture végétarienne et moi nous voyons rarement les choses du même œil.

**La personne que je suis** : L'organisation est la clé de ma santé mentale - chaque chose a sa place désignée et doit y retourner. J'aime les espaces verts et la verdure, je trouve de la joie à jouer avec les enfants, et je crois à enseigner aux autres ce que j'ai appris. Ma paresse est en fait mon super-pouvoir, me poussant à trouver les solutions permanentes les plus faciles pour les tâches quotidiennes. J'évite même d'écrire avec des stylos parce que je suis si engagé dans l'efficacité !

**Ma philosophie** : Je suis adaptable dans les relations, reflétant l'énergie de ceux qui m'entourent. Je préfère inspirer les autres plutôt que de chercher l'inspiration, et je vis selon une règle simple : tant que vous ne faites pas de mal aux autres, tout ce que vous faites est valable. La confiance et l'authenticité sont non négociables dans mes amitiés.

**Ce que vous pouvez attendre** : Ce blog partagera mon monde non technique - les leçons apprises de la vie quotidienne, les erreurs qui m'ont enseigné quelque chose de précieux, et les aperçus gagnés du simple fait d'être humain. J'accueille vos pensées et suggestions à travers le formulaire de contact. Merci de vous être arrêté, et j'espère que vous me rejoindrez dans ce voyage de la vie au-delà du monde professionnel !`,
