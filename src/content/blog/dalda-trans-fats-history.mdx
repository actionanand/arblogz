...
import { MOLECULAR_SATURATED } from "@/data/svg/molecular-saturated.ts";
import { MOLECULAR_UNSATURATED } from "@/data/svg/molecular-unsaturated.ts";
import { MOLECULAR_CIS } from "@/data/svg/molecular-cis.ts";
import { MOLECULAR_TRANS } from "@/data/svg/molecular-trans.ts";
import { HYDROGENATION_PROCESS } from "@/data/svg/hydrogenation-process.ts";
import { PALMOLEIN_PACKING } from "@/data/svg/palmolein-packing.ts";
import { HYDROGENATION_REACTION } from "@/data/svg/hydrogenation-reaction.ts";
import { THREE_OUTCOMES } from "@/data/svg/three-outcomes.ts";
...
<SvgWrapper svg={MOLECULAR_SATURATED} width="100%" />

**Double Bond (Unsaturated):**

<SvgWrapper svg={MOLECULAR_UNSATURATED} width="100%" />

**Single Bond (Saturated): ASCII Art**
```
    H   H   H   H
    |   |   |   |
—C—C—C—C—C—
...
**Double Bond (Unsaturated):  ASCII Art**
```
    H       H
    |       |
—C—C=C—C—
...
<SvgWrapper svg={PALMOLEIN_PACKING} width="100%" />

```
Palmolein Fatty Acids (Unsaturated - Kinked): ASCII Art
...
<SvgWrapper svg={HYDROGENATION_REACTION} width="100%" />
...
<SvgWrapper svg={MOLECULAR_CIS} width="100%" />
...
<SvgWrapper svg={MOLECULAR_TRANS} width="100%" />
...
<SvgWrapper svg={THREE_OUTCOMES} width="100%" />
...
<SvgWrapper svg={HYDROGENATION_PROCESS} width="100%" />
