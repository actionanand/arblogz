...
```md
![lazy](https://upload.wikimedia.org/wikipedia/commons/thumb/e/e6/Fry_piece_chicken_mandi.jpg/330px-Fry_piece_chicken_mandi.jpg)
```
...
For lazy loading: we need to enter `lazy` in `src`, and the real address of the image in `data-stc`. If you don't want to use this feature, just enter the image's real address in `src`.
...
<div class="image-cols-2">
  <img src="lazy" data-src="https://astro-yi.obs.cn-east-3.myhuaweicloud.com/pexels-photo-8536415.jpeg">
  <img class="row-span-2" src="lazy" data-src="https://astro-yi.obs.cn-east-3.myhuaweicloud.com/pexels-jeffer-berrire-9027257.jpg">
  <img src="lazy" data-src="https://astro-yi.obs.cn-east-3.myhuaweicloud.com/pexels-kyle-miller-20582700.jpg">
</div>
```
