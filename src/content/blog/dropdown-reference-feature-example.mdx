...
<Dropdown defaultValue=":::drop english" placeholder="Choose language..." client:load>
  <DropdownOption value=":::drop english" label="🇬🇧 English" />
  <DropdownOption value=":::drop spanish" label="🇪🇸 Español" />
  <DropdownOption value=":::drop french" label="🇫🇷 Français" />
</Dropdown>

<DropdownRef type="drop" id="english">
## Welcome to the Reference System!

This content is defined **outside** the dropdown component using `<DropdownRef>`.

### Benefits:
- **Better organization** - Keep dropdown definitions concise
- **Easier editing** - Content is not nested deeply
- **Reusability** - Reference the same content from multiple places
- **Cleaner code** - Separate structure from content
...
const greeting = "Hello from English!";
console.log(greeting);
```

> 💡 **Pro Tip:** Use references for any content longer than 20-30 lines!
</DropdownRef>
