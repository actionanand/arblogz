...
<Dropdown stripCss defaultValue="test" client:load>
  <DropdownOption value="test" label="With Tabs">
    <Tabs defaultValue="imp" client:load>
      <TabItem value="basic" label="Tab 1">Content</TabItem>
      <TabItem value="imp" label="Tab 2">Content</TabItem>
    </Tabs>
  </DropdownOption>
</Dropdown>
