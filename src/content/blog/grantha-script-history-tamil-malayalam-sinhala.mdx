...
## <Highlight color='#800031' highlight='fg' fontWeight='bold'> Special Symbols in Tamil Script </Highlight>

### <Highlight color='#004080' highlight='fg' fontWeight='bold'> Beyond Letters — Tamil's Administrative Symbols </Highlight>
...
### <Highlight color='#004080' highlight='fg' fontWeight='bold'> The Seven Administrative Symbols </Highlight>
...
### <Highlight color='#004080' highlight='fg' fontWeight='bold'> How a Date Was Written </Highlight>
...
```
வருடம் கிரேகி, மாதம் ஆடி, நாள் 15
Year: Grēki (a Tamil year name), Month: Āṭi, Day: 15
```

The three symbols — ௵ ௴ ௳ — compress "வருடம் … மாதம் … நாள் …" into single characters, saving precious space on narrow palm leaves and reducing scribal effort across thousands of entries.

Similarly, an account entry:

```
௹ ௫௰ ௸ (meaning: Rupee 50, as above/ditto — same as the prior entry)
```

---

### <Highlight color='#004080' highlight='fg' fontWeight='bold'> Tamil Numerals and Number System </Highlight>
...
### <Highlight color='#004080' highlight='fg' fontWeight='bold'> Two More Unique Tamil Characters </Highlight>
...
### <Highlight color='#004080' highlight='fg' fontWeight='bold'> Why These Symbols Matter for Script History </Highlight>
...
:::tip[Unicode Preservation]
All these characters are permanently preserved in Unicode (Tamil block, U+0B80–U+0BFF). Even though most modern Tamil writers use Arabic digits and the ₹ symbol for rupees, the original Tamil symbols remain digitally accessible — and are still used in traditional almanacs, temple publications, and classical scholarship.
:::
...
If you're learning Malayalam from Tamil (see our [Part 1](/blog/learn-malayalam-from-tamil-script) and [Part 2](/blog/learn-malayalam-from-tamil-script-part2) guides), understanding Grantha gives you the *why* behind the visual connections. When a Tamil ka (க) looks similar to a Malayalam ka (ക), it's because both ultimately derive from the same Grantha ancestor — they're not just similar by coincidence, they're family.
:::

---

*Interested in exploring script relationships further? See [Learn Malayalam Script from Tamil — Part 1](/blog/learn-malayalam-from-tamil-script) and [Part 2](/blog/learn-malayalam-from-tamil-script-part2), or dive into [Sanskrit and Its Linguistic Family](/blog/sanskrit-linguistic-family-guide).*

:::explore
[>] Wikipedia - [கிரந்த எழுத்துமுறை](https://ta.wikipedia.org/wiki/%E0%AE%95%E0%AE%BF%E0%AE%B0%E0%AE%A8%E0%AF%8D%E0%AE%A4_%E0%AE%8E%E0%AE%B4%E0%AF%81%E0%AE%A4%E0%AF%8D%E0%AE%A4%E0%AF%81%E0%AE%AE%E0%AF%81%E0%AE%B1%E0%AF%88)
