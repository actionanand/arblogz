...
| **Chana Dal / Bengal Gram / Gram Dal** | கடலை பருப்பு (Kadalai Paruppu) | ಕಡಲೆ ಬೇಳೆ (Kadale Bele) | चना दाल (Chana Dal) | **Yellow, split, larger than toor** - Looks like split chickpea | **Dal, Halwa, Paruppu Vadai(Dal vada/ Masala vada), Poriyal** |
...
| **Urad Gola / Urad Dal (Whole White without skin)** | முழு உளுந்து (தோல் இல்லாமல்) / முழு உருட்டு உளுந்து (தோல் இல்லாமல்) (Muzhu Ulundhu / Muzhu Uruttu Ulunthu) | ಬಿಳಿ ಉದ್ದು (Bili Uddu) | साबुत सफेद उड़द (Saabut Safed Urad) | **White, whole, oval** - Skinless whole urad | **Payasam, Ladoo, Kozhukattai** |
