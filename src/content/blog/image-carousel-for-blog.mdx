...
**Design Credit:** Book card design inspired by <cite>Codepen - Pure CSS Carousel[^1]</cite>
[^1]: Pure CSS Carousel design from [Codepen](https://codepen.io/ancaspatariu/pen/WpQYOP).
