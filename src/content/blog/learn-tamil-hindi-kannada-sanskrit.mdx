...
tags: ['tamil', 'hindi', 'kannada', 'sanskrit', 'language learning', 'grammar', 'indian languages']
category: Education
showDonate: true
sticky: 1
outdated: 0
...
|---------|-------|-----------|
| The book is on the table | புத்தகம் மேசையின் மேல் இருக்கிறது | புத்தகம் (book) + மேசையின் மேல் (table-'s on) + இருக்கிறது (is) |
| I came from Chennai | நான் சென்னையிலிருந்து வந்தேன் | நான் (I) + சென்னையிலிருந்து (Chennai-from) + வந்தேன் (came) |
| Go to the house | வீட்டுக்கு செல் | வீட்டுக்கு (house-to) + செல் (go) |
| She is with her friend | அவள் தன் தோழியோடு இருக்கிறாள் | அவள் (she) + தன் (her) + தோழியோடு (friend-with) + இருக்கிறாள் (is) |
| For you only | உனக்காகத்தான் | உனக்காக (you-for) + தான் (only/emphasis) |
| In those things | அவற்றில் | அவை (those) + இல் (in) → அவற்றில் |
| From those places | அவற்றிலிருந்து | அவை (those) + இல் (in) + இருந்து (from) → அவற்றிலிருந்து |
| I like you | நான் உன்னை விரும்புகிறேன் | நான் (I) + உன்னை (you-object) + விரும்புகிறேன் (like) |
| It's with me | என்னிடம் இருக்கிறது | என்னிடம் (with me) + இருக்கிறது (is) |
| About this matter | இதைப் பற்றி | இதை (this-object) + பற்றி (about) |
| Better than that | அதைவிட நல்லது | அதைவிட (than that) + நல்லது (good) |
...
|---------|-------|-----------|  
| The book is on the table | किताब मेज़ पर है | किताब (book) + मेज़ पर (table-on) + है (is) |
| I came from Delhi | मैं दिल्ली से आया | मैं (I) + दिल्ली से (Delhi-from) + आया (came) |
| Go to the house | घर को जाओ | घर को (house-to) + जाओ (go) |
| She is with her friend | वह अपनी दोस्त के साथ है | वह (she) + अपनी दोस्त के साथ (friend-with) + है (is) |
| For you only | तुम्हारे लिए ही | तुम्हारे लिए (you-for) + ही (only/emphasis) |
| I like you | मैं तुम्हें पसंद करता हूँ | मैं (I) + तुम्हें (you-object) + पसंद करता हूँ (like) |
| It's with me | मेरे पास है | मेरे पास (with me) + है (is) |
| About you | तुम्हारे बारे में | तुम्हारे (your) + बारे में (about) |
| Better than you | तुमसे अच्छा | तुमसे (than you) + अच्छा (good) |
...
|---------|---------|-----------|  
| The book is on the table | ಪುಸ್ತಕ ಮೇಜಿನ ಮೇಲೆ ಇದೆ | ಪುಸ್ತಕ (book) + ಮೇಜಿನ ಮೇಲೆ (table-on) + ಇದೆ (is) |
| I came from Bangalore | ನಾನು ಬೆಂಗಳೂರಿನಿಂದ ಬಂದೆ | ನಾನು (I) + ಬೆಂಗಳೂರಿನಿಂದ (Bangalore-from) + ಬಂದೆ (came) |
| Go to the house | ಮನೆಗೆ ಹೋಗು | ಮನೆಗೆ (house-to) + ಹೋಗು (go) |
| She is with her friend | ಅವಳು ತನ್ನ ಗೆಳತಿಯೊಂದಿಗೆ ಇದ್ದಾಳೆ | ಅವಳು (she) + ತನ್ನ ಗೆಳತಿಯೊಂದಿಗೆ (friend-with) + ಇದ್ದಾಳೆ (is) |
| For you only | ನಿನಗಾಗಿ ಮಾತ್ರ | ನಿನಗಾಗಿ (you-for) + ಮಾತ್ರ (only) |
| I like you | ನಾನು ನಿನ್ನನ್ನು ಇಷ್ಟಪಡುತ್ತೇನೆ | ನಾನು (I) + ನಿನ್ನನ್ನು (you-object) + ಇಷ್ಟಪಡುತ್ತೇನೆ (like) |
| It's with me | ನನ್ನ ಹತ್ತಿರ ಇದೆ | ನನ್ನ ಹತ್ತಿರ (with me) + ಇದೆ (is) |
| About you | ನಿನ್ನ ಬಗ್ಗೆ | ನಿನ್ನ (your) + ಬಗ್ಗೆ (about) |
| Better than you | ನಿನಗಿಂತ ಉತ್ತಮ | ನಿನಗಿಂತ (than you) + ಉತ್ತಮ (good) |
...
|---------|----------|-----------|  
| The book is on the table | पुस्तकं मेजस्य उपरि अस्ति | पुस्तकं (book) + मेजस्य उपरि (table-on) + अस्ति (is) |
| I came from Delhi | अहं दिल्लीतः आगतः | अहं (I) + दिल्लीतः (Delhi-from) + आगतः (came) |
| Go to the house | गृहं गच्छ | गृहं (house-to/accusative) + गच्छ (go) |
| She is with her friend | सा स्व-मित्रेण सह अस्ति | सा (she) + स्व-मित्रेण सह (friend-with) + अस्ति (is) |
| For you | तुभ्यम् | तुभ्यम् (for you - dative case) |
| I like you | अहं त्वाम् रोचामि | अहं (I) + त्वाम् (you-object) + रोचामि (like) |
| It's with me | मम समीपे अस्ति | मम समीपे (with me) + अस्ति (is) |
| About you | त्वयि विषये | त्वयि (you-locative) + विषये (about) |
| Better than you | त्वत्तः अधिकं उत्तमम् | त्वत्तः (than you) + अधिकं उत्तमम् (more good) |
