...
<Tabs defaultValue="backward" client:load>
  ...
  <TabItem value="backward" label="🔄 Backward Compatible">
    ## Use Tab or TabItem
  ...
  <TabItem value="required" label="📋 Required Props">
    ## What You Need
...
<Tabs defaultValue="basics" client:load>
  <TabItem value="basics" label="📝 Text Formatting">
  ...
  <TabItem value="quotes" label="💬 Quotes & Callouts">
  ...
  <TabItem value="tables" label="📊 Tables & More">
    ...
    |---------|------------|----------|-------|
    | Markdown Support | ❌ No | ✅ Yes | Full MDX compatibility |
    | Syntax Highlighting | ❌ No | ✅ Yes | Expressive Code integration |
    | Theme Switching | ❌ No | ✅ Yes | Real-time, no refresh needed |
    | Mobile Responsive | ⚠️ Manual | ✅ Yes | Built-in responsive design |
    | Copy Code Button | ❌ No | ✅ Yes | Automatic with Expressive Code |
    | Line Numbers | ❌ No | ✅ Yes | Configurable per code block |
...
<Tabs defaultValue="defaults" client:load>
  <TabItem value="defaults" label="🎯 Default Tab Selection">
  ...
  <TabItem value="auto-names" label="🏷️ Auto-Generated Names">
