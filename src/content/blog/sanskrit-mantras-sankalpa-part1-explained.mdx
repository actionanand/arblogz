...
## <Highlight color='#800031' highlight='fg' fontWeight='bold'> Sanskrit Word Richness — Multiple Names for One Thing </Highlight>
...
### <Highlight color='#004080' highlight='fg' fontWeight='bold'> The Lotus — A Word with Many Names (कमल / Kamala) </Highlight>
...
:::tip[Why So Many Words for Lotus?]
In Sanskrit poetic and religious literature, the choice of which lotus-word to use is itself a creative and philosophical act. A poet who writes **Padma** is evoking divine grace; one who writes **Paṅkaja** is evoking spiritual transformation (beauty rising from mud); one who writes **Saroja** is evoking the lake's stillness. Each name is a complete idea, not just a label.
:::
...
:::note[Why So Many Words for "Eyes"?]
Sanskrit has multiple words for eyes — **Akṣa, Nayana, Netra, Locana, Cakṣus** — each subtly different. **Akṣa** emphasizes the eye as an organ of perception. **Nayana** means the leading/guiding eye (from *nī*, to lead). **Netra** means the guiding eye (from *nī*, to guide). **Locana** means the shining/glowing eye. In poetry, the choice of which eye-word to use with which lotus-word creates deliberate aesthetic and philosophical resonance.
:::
