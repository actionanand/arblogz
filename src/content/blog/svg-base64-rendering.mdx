...
## Example 2: Imported Check Icon

<SvgWrapper svg={CHECK_ICON} className="svg-small" />
...
## Example 5: Imported Info Icon with Styling

<SvgWrapper svg={INFO_ICON} className="with-shadow bordered" width="120px" />
...
## Example 7: Imported Circle with Pulse

<SvgWrapper svg={SIMPLE_CIRCLE} className="pulse-animation" />
...
## Example 11: Basic Base64 Image (No Lazy Loading)

<Base64Image src={DEMO_IMAGE} alt="Demo image" width="300px" />

---

## Example 12: Base64 Image with Shadow (No Lazy)

<Base64Image src={SAMPLE_LANDSCAPE} alt="Landscape" width="400px" className="with-shadow" />

---

## Example 13: With Lazy Loading + Spinner (Requires `client:load`)

<Base64Image src={SAMPLE_PORTRAIT} alt="Portrait" width="250px" className="bordered" lazy={true} client:load />
...
## Example 16: Lazy Loading with Custom Delay (2 seconds)
