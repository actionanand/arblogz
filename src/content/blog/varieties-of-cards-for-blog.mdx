...
> **Hydration Required:** Add `client:load` directive to each `BookCard` component for interactivity.[^6]
...
- `client:load` - Astro directive to enable interactivity **(required)**[^6]
...
**Design Credit:** Book card design inspired by <cite>Codepen - Maza designDev[^7]</cite>

[^6]: **Astro Client Directives**: BookCard requires `client:load` to enable React hydration for interactive flip and expansion functionality. Learn more about [Astro client directives](https://docs.astro.build/en/reference/directives-reference/#client-directives).

[^7]: Flip card design from [Codepen - Maza designDev's flip card](https://codepen.io/).
