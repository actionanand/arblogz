...
|------|------|----------|---------|-------------|
| `image` | string | Notebook: No<br/>Fancy: Yes<br/>Simple: Yes | - | URL or path to the image. Optional for Notebook cards (text-only mode) |
...
<div style={{ backgroundColor: '#f5f5f5', padding: '2rem' }}>
  <DogearCardContainer>
    {/* All cards should use bgColor="#f5f5f5" to match the container */}
    ...
    <DogearCard title="Custom" customColor="#ff6b6b" bgColor="#f5f5f5">
      <p>Any custom hex color!</p>
    </DogearCard>
  </DogearCardContainer>
</div>

keep DogearCardContainer while using single card also or the card will go till edge which won't look good.

<DogearCardContainer>
  <DogearCard title="Teal" color="green" bgColor="#f5f5f5">
    <p>Default teal color.</p>
  </DogearCard>
</DogearCardContainer>
