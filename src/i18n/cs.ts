...
export  let cs = {
  ...
  'sidebar.moreTags': 'více štítků',
  'sidebar.moreCategories': 'více kategorií',
  'sidebar.showLess': 'Zobrazit méně',
  'media.videoResources': 'Videozdroje',
  'media.mute': 'Ztlumit',
  'media.unmute': 'Zrušit ztlumení',
  'media.openOnYouTube': 'Sledovat na YouTube',
  'media.viewOnInstagram': 'Zobrazit na Instagramu',
  'sidebar.tags': 'Štítky',
...
Při výběru jazyků pro překlady na svém blogu jsem se vědomě rozhodl zaměřit na jazyky, kterými lidé dnes aktivně mluví—živé jazyky. Ačkoliv existuje mnoho starověkých a klasických jazyků s pozoruhodnými dějinami, některé se již nepoužívají pro každodenní komunikaci. Mým cílem bylo zajistit přístupnost a relevanci pro široké, současné publikum.

**Angličtina** byla nezbytnou volbou vzhledem k její roli jako globální lingua franca a širokému použití v mezinárodní komunikaci, obchodu a technologiích.

**Čínština** (zjednodušená i tradiční) byla zahrnuta kvůli svému postavení nejmluvnějšího jazyka světa, pokrývajícího obrovské populace v Číně, na Tchaj-wanu, v Hongkongu a v zahraničních komunitách.

**Hindština** se mluví obrovskou populací po celé Indii, zejména v regionech, kde je hindština primárním komunikačním médiem (severní část Indie). Zahrnutí hindštiny zajišťuje, že můj obsah dosáhne významnou část indické populace.

**Kannadština** si zaslouží zvláštní zmínku. Jako někdo, kdo pracuje v Bangalore, srdci Karnátaky, jsem chtěl dát přednost místnímu jazyku. Kannadština je významný jihoindický jazyk s bohatou literární tradicí a miliony mluvčích. Jeho zahrnutí odráží jak můj osobní vztah k regionu, tak mou úctu k jeho živé kultuře.

**Francouzština** byla vybrána pro svůj globální dosah, mluví se jí napříč Evropou, Afrikou, Severní Amerikou a částmi Asie. Francouzština je také jazykem kultury, diplomacie a mezinárodních vztahů.

**Čeština** představuje můj závazek k evropské rozmanitosti, spojuje se s publikem ve střední Evropě a uznává živou kulturu a historii České republiky.

**Arabština** byla přidána pro svou důležitost na Středním východě a v severní Africe, stejně jako pro svou roli klasického a živého jazyka s hlubokým historickým a náboženským významem.

Stručně řečeno, jazyky, které jsem vybral—tamilština, angličtina, čínština (zjednodušená a tradiční), hindština, francouzština, čeština, arabština a kannadština—jsou všechny živé jazyky, kterými aktivně mluví miliony lidí po celém světě. Tamilština, kannadština a hindština jsou tři z 22 oficiálních jazyků Indie. Ačkoliv ctím dědictví starověkých jazyků, mé zaměření je na ty, které dnes nadále spojují lidi, čímž zajišťuji, že můj blog je přístupný, relevantní a inkluzivní pro skutečně globální publikum.`,
